...
5. Vraag door zolang verplichte velden nog nodig maar onbekend zijn (status 'needs_input'): state='ask' zolang die er zijn, state='ready' als alle verplichte velden 'filled' of 'unknown' zijn. Er is geen vast aantal. Stop wanneer verdere vragen vooral administratie opleveren.
